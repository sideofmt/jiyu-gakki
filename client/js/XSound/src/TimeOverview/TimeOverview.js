(function(global) {
    ...
    TimeOverview.prototype.drawToSVG = function(data) {
        ...
        // Begin drawing
        svg.appendChild(this.drawTimeDomainFloat32ArrayToSVG(data, innerWidth, innerHeight, middle, nPlotinterval, Mocks.SoundModule.Analyser.Visualizer.SVG_LINEAR_GRADIENT_IDS.TIME_OVERVIEW));
